package com.xyzbank.automationway.testsuite;

import com.xyzbank.automationway.pages.*;
import com.xyzbank.automationway.testbase.BaseTest;
...
public class BankTest extends BaseTest {
    ...
    public void bankManagerShouldAddCustomerSuccessfully() {
        ...
        //enter FirstName
        addCustomerPage.enterFirstName("JainaA");
        //enter LastName
        addCustomerPage.enterLastName("Patel");
        //enter PostCode
        addCustomerPage.enterPostcode("CR2 7SS");
        //click On "Add Customer" Button
        addCustomerPage.clickOnAddCustomerButton();
        //popup display
        //verify message "Customer added successfully"
        Assert.assertEquals(bankManagerLoginPage.getPopupMsg(),
                "Customer added successfully with customer id :8",
                "Message not found");
    ...
    public void customerShouldLoginAndLogoutSuccessfully() {
        ...
        customersPage.searchAndSelectNameFormDropdown("JainaA Patel");
